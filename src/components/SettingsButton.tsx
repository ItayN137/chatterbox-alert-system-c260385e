...
import { Settings, Moon, Sun, Calendar as CalendarIcon, List } from 'lucide-react';
...
const SettingsButton: React.FC<SettingsButtonProps> = ({ onViewModeChange, viewMode = 'list' }) => {
